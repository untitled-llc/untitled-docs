    ...
    Esquire: ['esquire/overview',
             { type: 'category', 
               label:'Zipcodes and Observations', 
                     items: ['esquire/zipcodes-observations/overview','esquire/zipcodes-observations/tap-onspot','esquire/zipcodes-observations/lambda', 'esquire/zipcodes-observations/s3','esquire/zipcodes-observations/redshift-glue', 'esquire/zipcodes-observations/docker-image']}, 
             { type: 'category', 
               label:'Ads Metrics', 
